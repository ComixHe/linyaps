...
bool lock(const file_descriptor_wrapper &fd, bool blocked, short lock_type = F_WRLCK) noexcept
{
    struct flock fl{ };
    fl.l_type = lock_type;
...
bool unlock(const file_descriptor_wrapper &fd) noexcept
{
    struct flock fl{ };
    fl.l_type = F_UNLCK;
    fl.l_whence = SEEK_SET;
